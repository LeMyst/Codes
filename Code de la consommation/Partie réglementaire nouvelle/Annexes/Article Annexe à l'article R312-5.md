...
| -une assurance liée au crédit ?  | Oui/ non ; \[si oui, préciser le type d'assurance, et ajouter la mention suivante :
...
Lorsque l'assurance est proposée ou exigée par le prêteur, coût de cette assurance exprimé à l'aide d'un exemple chiffré en taux annuel effectif de l'assurance, en montant total dû en euro et par mois sur la base de la cotisation mensuelle la plus élevée. | Oui/ non ; \[si oui, préciser le type de service accessoire\]  |
...
| Oui (Le cas échéant)Lorsque le contrat de crédit est un crédit affecté, la rétractation sur le contrat de crédit entre le premier et le quatorzième jour met fin au contrat de vente ou de prestation de services.
