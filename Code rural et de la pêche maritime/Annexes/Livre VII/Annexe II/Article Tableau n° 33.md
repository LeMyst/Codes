...
| | | |
| --- | --- | --- |
| DÉSIGNATION DES MALADIES | DÉLAI DE PRISEen charge | TRAVAUX SUSCEPTIBLES de provoquer ces maladies |
...
| - formes à rechutes. | 60 jours | Travaux exposant au contact d'eaux usées lors de l'installation, l'exploitation et l'entretien des réseaux d'assainissement.Travaux exposant au contact d'eaux usées dans les cuisines de restauration collective. |
