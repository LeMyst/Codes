...
Énumérer les différents crédits.  | Montant, taux débiteur (2) et montant des échéances du regroupement (3) :  |
| Montant des autres dettes regroupées :
Énumérer les différentes dettes.  |
| Durée de remboursement :
Énumérer les différents crédits.  | Durée de remboursement :  |
