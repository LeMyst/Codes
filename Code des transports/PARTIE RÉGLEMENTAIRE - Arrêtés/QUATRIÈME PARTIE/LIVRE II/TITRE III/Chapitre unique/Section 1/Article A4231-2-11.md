...
1. Les certificats de qualification pour le niveau de base et le niveau opérationnel sont délivrés selon le modèle correspondant de l'ES-QIN (partie V, chapitre 2).
